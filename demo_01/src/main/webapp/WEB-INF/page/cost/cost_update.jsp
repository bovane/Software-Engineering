...
<form action="" method="post" class="form-horizontal">
    <h5 class="page-header alert-info"
        style="margin: 0px; padding: 10px; margin-bottom: 10px">费用
        基本信息</h5>
    <div class="row">
        <div class="col-sm-7">
...
<textarea rows="" cols="" class="form-control"
        ...
        <div class="row">
            <div class="col-sm-7" align="center">
                <input type="submit" value=" 修改费用 " class="btn btn-
sucess"> <a
                    href="cost/list.do" class="btn btn-danger">返回上
                一级</a>
            </div>
        </div>
    </div>
