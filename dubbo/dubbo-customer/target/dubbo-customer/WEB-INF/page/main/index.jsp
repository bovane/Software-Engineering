            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue"><a data-toggle="dropdown" href="#"
                                          class="dropdown-toggle"> <img class="nav-user-photo"
                                                                        src="res/assets/avatars/user.jpg"
                    ...
                    <ul
                        ...
                        <li><a href="login.do"> <i class="icon-off"></i> 退出
                        </a></li>
                    </ul>
                </li>
            </ul>
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                <li class="active"><a
                        href="bootm.do" target="mainframe">
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="user/list.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 员工管理
                        </a></li>

                        <li><a href="role/list.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 角色管理
                        </a></li>

                        <li><a href="menu/list.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 菜单管理
                        </a></li>

                        <li><a href="authority/list.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 权限管理
                        </a></li>

                        <li><a href="cost/list.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 费用管理
                        </a></li>
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                       class="dropdown-toggle"> <i class="icon-desktop"></i> <span
                        class="menu-text"> 报销管理 </span> <b class="arrow icon-angle-down"></b>
                </a>
                    <ul class="submenu">
                        <li><a href="expense/add.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 报销单
                        </a></li>

                        <li><a href="expense/loadAuditManager.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 负责人审核
                        </a></li>

                        <li><a href="expense/loadAuditFinance.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 财务审核
                        </a></li>

                        <li><a href="expense/mylist.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 我的报销
                        </a></li>

                        <li><a href="expense/list.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 报销查询
                        </a></li>

                        <li><a href="expense/myauditlist.do" target="mainframe"> <i
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                       class="dropdown-toggle"> <i class="icon-desktop"></i> <span
                        class="menu-text">薪资管理 </span> <b class="arrow icon-angle-down"></b>
                </a>
                    <ul class="submenu">
                        <li><a href="salary/loadadd.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 薪资发放
                        </a></li>
                        <li><a href="salary/list.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 薪资发放查询
                        </a></li>
                    </ul>
                </li>
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                    ...
                    <ul class="submenu">
                        <li><a href="salary/loadadd.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 报表管理
                        </a></li>
                    </ul>
                </li>
