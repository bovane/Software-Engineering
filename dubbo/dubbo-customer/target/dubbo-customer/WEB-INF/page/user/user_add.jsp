...
<form action="user/add.do" method="post" data-validate-option="{theme:'yellow_right_effect',stopOnError:true}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="password" class="form-control" name="userPassword"
                           placeholder="请输入用户密码" data-rule="用户密码:required;"/>
                </div>
            </div>
        </div>
